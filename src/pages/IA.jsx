...
const IA = () => {
  ...
  const ativos = [
    'Ethereum (OTC)', 'Bitcoin (OTC)', 'Dogecoin (OTC)', 'Solana (OTC)',
  ];
  ...
  const generateAnalysis = () => {
    ...
    const executeStep = () => {
      if (currentStep < steps.length) {
        ...
        // Ativo principal sempre Ethereum (OTC)
        const ativoSinal = 'Ethereum (OTC)';
        // Plano B pode ser qualquer ativo da lista
        const ativoPlanoB = ativos[Math.floor(Math.random() * ativos.length)];
